...
| Using [uv](https://docs.astral.sh/uv/getting-started/installation/)<br/>`uv tool install gimmegit` | | Using [pipx](https://pipx.pypa.io/stable/installation/)<br/>`pipx install gimmegit` |
|-|-|-|
